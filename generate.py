...
def Create_Robot():
    ...
    pyrosim.Send_Joint( name = "Torso_FrontLeg" , parent= "Torso" , child = "FrontLeg" , type = "revolute", position = [0,1,2])
...
def Generate_Brain():
    ...
    pyrosim.Send_Synapse( sourceNeuronName = 0 , targetNeuronName = 3 , weight = 3.0 )
    pyrosim.Send_Synapse( sourceNeuronName = 1 , targetNeuronName = 3 , weight = 3.0 )
    pyrosim.Send_Synapse( sourceNeuronName = 1 , targetNeuronName = 2 , weight = 3.0 )
    pyrosim.Send_Synapse( sourceNeuronName = 0 , targetNeuronName = 1 , weight = 3.0 )
    pyrosim.Send_Synapse( sourceNeuronName = 0 , targetNeuronName = 2 , weight = 3.2 )
    pyrosim.End()
